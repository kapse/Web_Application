			...
			<div id="iratbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
				<div class="panel panel-info" >
                    <div class="panel-heading">
                        <div class="panel-title"><h2><strong><p align="center">Select your preferred Test.</p></strong></h2></div>
							...
							<form id="registrationform" class="form-horizontal" role="form">                                   
								...
								<div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                      <p align="center"><a id="btn-login" href="irat.jsp" class="btn btn-success">IRAT  </a></p>
                                    </div>
                                </div>
								<div style="margin-top:10px" class="form-group">
                                    <!-- Button -->
                                    <div class="col-sm-12 controls">
                                      <p align="center"><a id="btn-login" href="trat_team_leader.jsp" class="btn btn-success">TRAT  </a></p>
                                    </div>
                                </div>
